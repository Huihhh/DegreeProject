...
from trainer.hDistance_logger import HDistanceLogger
from trainer.linearRegion_logger import LinearRegionLogger
from trainer.artifacts_logger import ArtifactLogger
...
def main(CFG: DictConfig) -> None:
    ...
    trainer.fit(litModel, datamodule=dataset)
    logger.info("======= Testing =======")
