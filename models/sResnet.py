...
def downsample(in_planes: int, out_planes: int) -> nn.Sequential:

    return nn.Sequential(OrderedDict([
        ('conv', nn.Conv2d(in_planes, out_planes, kernel_size=1, stride=2, bias=False)),
...
class SResNet(Module):
    def __init__(self,
        ...
        self.resnet = nn.Sequential(OrderedDict([
            ('conv', nn.Conv2d(3, 32, 7, stride=2, padding=3, bias=False)),
            ('bn', nn.BatchNorm2d(32)),
            ('ac', nn.ReLU()),
            # ('pool', nn.MaxPool2d(3, stride=2, padding=1)),
            ('res1', BasicBlock(32, 32)),
            ('res2', BasicBlock(32, 64, 2, downsample=downsample(32, 64))),
            ('res3', BasicBlock(64, 64)),
            ('res4', BasicBlock(64, 128, 2, downsample=downsample(64, 128))),
            ('res5', BasicBlock(128, 128)),
            ('res6', BasicBlock(128, 256, 2, downsample=downsample(128, 256))),
            ('res7', BasicBlock(256, 256)),
            ('res8', BasicBlock(256, 512, 2, downsample=downsample(256, 512))),
            ('res9', BasicBlock(512, 512)),
